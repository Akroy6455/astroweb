...
pattern = r"export async function getKundliData\(formData: FormData\).*?export async function getTaraNirnayData"
content = re.sub(pattern, new_getkundlidata.strip() + "\n\nexport async function getTaraNirnayData", content, flags=re.DOTALL)
